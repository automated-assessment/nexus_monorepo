...
#
# Based on original script from https://github.com/cirocosta/gitserver-http/blob/master/entrypoint.sh
# Changes in this version:
#
# - Removing all repositories at startup before recreating them.
...
initialize_initial_repositories() {
  echo "Cleaning out old repositories."
  cd $GIT_PROJECT_ROOT
  rm -rf ./*

  echo "Initialising repositories from $GIT_INITIAL_ROOT"
  cd $GIT_INITIAL_ROOT
