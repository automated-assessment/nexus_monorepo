...
init-env: .env.list .env.uat.list .env.javac.list .env.rng.list .env.iograder.list .env.conf.list .env.peerfeedback.list .env.matlab.list .env.sag.list .env.junit.list
