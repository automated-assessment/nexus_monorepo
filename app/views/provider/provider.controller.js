...
(function() {
    angular.module('PeerFeedback')
        .controller('ProviderController', ['$sce', '$stateParams', function ($sce, $stateParams,provider) {
            ...
            vm.alias = provider.alias;
            vm.currentForm = provider.currentForm;
            vm.provided = provider.provided;
